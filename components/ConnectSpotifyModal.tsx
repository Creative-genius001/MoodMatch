...
const ConnectSpotifyModal = () => {
  ...
  return (
    <div className='absolute h-[100%] w-[100%] top-0 left-0 z-[10000] bg-[#2020209d] flex justify-center items-center'>
        <Card className='w-[300px] h-auto px-4 py-8 relative'>
            <MdOutlineCancel onClick={() => setSpotifyModalActive(false)} className='absolute right-4 top-4 text-[1.5rem] text-[#3c3c3c] cursor-pointer ' />
