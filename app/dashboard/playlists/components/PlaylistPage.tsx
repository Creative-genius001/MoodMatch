...
const PlaylistPage = (props: {playlists: IPlaylist[]}) => {
    ...
    const [selectedCard, setSelectedCard] = useState<IPlaylist | null>(null)
  return (
    <main className='overflow-y-auto flex flex-col text-white pt-20 md:pt-0'>
        ...
        <div className="mt-3 flex flex-col md:flex-row gap-3">
            {playlists.map((playlist)=> (
                <Card onClick={()=> setSelectedCard(playlist)} key={playlist.snapshotId} className="w-full md:w-[400px] h-[100px] bg-[#ffffff09] p-4 cursor-pointer">
                    <div>
        ...
        {selectedCard && <CardModal playlist={selectedCard} onClose={() => setSelectedCard(null)} />}
